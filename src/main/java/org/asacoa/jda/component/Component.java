...
public class Component {
    ...
    public static LayoutComponent actionButton = ActionRow.of(
    ...
    public static LayoutComponent raidSelect = ActionRow.of(
            SelectMenu.create("raidType")
                    .setPlaceholder("Select Menu")
                    .addOption("쿠크세이튼", "Kakul-Saydon")
                    .addOption("아브렐슈드", "Abrelshud")
                    .addOption("일리아칸 ", "Illiakan")
                    .addOption("도전 시리즈", "Heroic")
                    .setDefaultOptions()
                    .build()
    );

    public static LayoutComponent difficulty = ActionRow.of(
